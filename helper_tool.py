...
class ConfigS3DIS:
    ...
    batch_size = 10  # batch_size during training
    val_batch_size = 20  # batch_size during validation and test
    train_steps = 500  # Number of steps per epochs
    val_steps = 100  # Number of validation steps per epoch
    ...
    noise_init = 3.5  # noise initial parameter
    max_epoch = 100  # maximum epoch during training
    learning_rate = 0.006  # initial learning rate
    lr_decays = {i: 0.95 for i in range(0, 500)}  # decay rate of learning rate
...
class DataProcessing:
    ...
    def get_class_weights(dataset_name):
        ...
        if dataset_name is 'S3DIS':
            num_per_class = np.array([1100556, 34201516, 420969, 583628, 4447354, 7544232, 2402849,3806926], dtype=np.int32)
